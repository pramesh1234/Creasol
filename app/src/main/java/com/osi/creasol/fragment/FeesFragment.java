...
import com.osi.creasol.databinding.FragmentFeesBinding;
import com.osi.creasol.viewmodel.FeesViewModel;

public class FeesFragment extends Fragment {

    FeesViewModel mViewModel;
    FragmentFeesBinding binding;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mViewModel = new FeesViewModel(this);
    }
    ...
    public static void addFragment(BaseActivity activity) {
        activity.replaceFragment(new FeesFragment(), true);
    }
}
